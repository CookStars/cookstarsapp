...
export const recipes = [
  {
    ...
    readyInMinutes: 45,
    servings: 2,
    imageURL: "https://spoonacular.com/recipeImages/658655-556x370.jpg",
    summary:
...

  {
    ...
    ingredients:
      "2 teaspoons dry active yeast, 2 tablespoons mixed cornstarch, 1 egg yolk, 3 tablespoons flour, 2 cloves garlic, ½ cups green onions, 4 teaspoons hoisin sauce, ½ cups milk, 8 dried mushrooms, 4 teaspoons oyster sauce, 1.5 cups pork, 1 tablespoon sugar, 2 tablespoons vegetable oil",
    instructions:
    ...
    analyzedInstructions: [
      {
        ...
        steps: [
          ...
          },
          {
            number: 2,
            step:
              "Cut off and discard stems; coarsely chop caps. Set aside. Cooking",
            ingredients: [],
            equipment: [],
          },
          {
          ...
          },
          {
            number: 5,
            step:
              "Add green onions, garlic, and mushrooms; stir-fry for 1 minute. Stir in water, hoisin sauce, and sugar; mix well.",
            ingredients: [
              {
                id: 11291,
                name: "green onions",
          ...
          },
          {
            number: 8,
            step:
              "Remove from heat and let cool. Punch down dough, then roll on a lightly floured surface into a 12-inch long cylinder. 7",
            ingredients: [],
            equipment: [],
          },
          {
            number: 9,
            step:
              "Bake in a 350 degree F oven for 18 to 20 minutes or until golden brown.",
            ingredients: [],
            equipment: [
              {
                id: 404784,
  ...
  },
  {
    ...
    ingredients:
      "1 pound lean boneless skinless chicken breast fillets, some lemon, 1 teaspoon fresh rosemary leaves, 2 teaspoons fresh thyme leaves, 2 cloves garlic, 1 teaspoon black peppercorns, 1 lemon (juice), 2 teaspoons olive oil",
    summary:
  ...
  },
  {
    ...
    ingredients:
      "¼ teaspoons black pepper, 125 grams butter, 2 Tbs corn flour, ½ cups cream, 2 teaspoons fresh rosemary, ½ cups lemon juice, 1 teaspoon lemon rind, 1 cup olive oil, 1 teaspoon black pepper, ½ cups sour cream, 4 veal cutlets",
    summary:
  ...
  },
  {
    ...
    ingredients:
      "2 pounds bone in chicken thighs, ½ diced yellow onion, 3 garlic cloves, 1 Tsp fresh thyme, 1 Tsp scotch bonnet pepper, ¼ Tsps powdered ginger, ¼ teaspoons curry powder, 1 Tsp coconut oil, 1 scallion, 1 Tbsp vegetable oil, ½ yellow onion, 3 garlic cloves, 1.5 Tbsps curry powder, 1 Tsp amchar masala, ½ Tsps cumin, 2 potatoes",
    summary:
  ...
  },
  {
    ...
    analyzedInstructions: [
      {
        ...
        steps: [
          ...
          },
          {
            number: 2,
            step:
              "Place a large heavy bottomed pot on the stove top (like a Le Creuset pot).",
            ingredients: [],
            equipment: [
              {
                id: 404794,
          ...
          },
          {
            number: 3,
            step:
              "Over medium heat cook 4 strips of Bacon in the large heavy bottomed pot until crisp.",
            ingredients: [
              {
                id: 10123,
                name: "bacon",
          ...
          },
          {
            number: 4,
            step:
              "Remove from the heat and allow to drain on paper towels.  Later you will crumble the Bacon into the finished Sauce.  Reserve the Bacon Fat in the pot.",
            ingredients: [
              {
                id: 10123,
                name: "bacon",
          ...
          },
          {
            number: 10,
            step:
              "Then over medium heat add the diced Onions and Carrot and saute until soft, 5-7 minutes.",
            ingredients: [
              {
                id: 11124,
                name: "carrot",
          ...
          },
          {
            number: 13,
            step:
              "Add the Beef Short Ribs and any juices that collected in the bowl to the boiling pot.",
            ingredients: [
              {
                id: 10013149,
                name: "beef short ribs",
          ...
          },
          {
            number: 14,
            step:
              "Put them in snugly against each other and boil for 2 minutes.",
            ingredients: [],
            equipment: [],
            length: {
              number: 2,
          ...
          },
          {
            number: 16,
            step:
              "After 3 hours remove from the oven and take off the lid.  Prepare for a steam facial!",
            ingredients: [],
            equipment: [
              {
                id: 404784,
          ...
          },
          {
            number: 17,
            step:
              "Remove the Cooked Beef Short Ribs to a large bowl.  Be gentle, it will be falling off the bone.  Allow the Sauce to sit for 3 minutes so the fat rises to the top.  Skim off the fat using a large spoon and discard it.",
            ingredients: [
              {
                id: 10013149,
                name: "beef short ribs",
          ...
          },
          {
            number: 19,
            step:
              "Remove the Bay Leaves and stems from the Thyme if you used fresh Thyme.",
            ingredients: [
              {
                id: 2049,
                name: "fresh thyme",
          ...
          },
          {
            number: 21,
            step:
              "Add the Beef Short Ribs back to the pot of reduced Sauce and remove from the heat.  Coat the Short Ribs in the Sauce well.",
            ingredients: [
              {
                id: 10013149,
                name: "beef short ribs",
          ...
          },
          {
            number: 22,
            step:
              "Serve Immediately over Yukon Gold Mashed Potatoes or Polenta.",
            ingredients: [],
            equipment: [],
          },
        ],
    ...
    originalId: null,
    spoonacularSourceUrl:
      "https://spoonacular.com/amazing-braised-beef-short-ribs-632299",
  },
];
const extraRecipes = [
  {
